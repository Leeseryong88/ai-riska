...
> = {
  analysis: {
    title: 'AI 분석',
    description: '사진과 작업 내용을 빠르게 분석하고 위험요인을 정리합니다.',
  },
  document: {
    title: '문서 작성',
...
export const services: ServiceDefinition[] = [
  ...
  },
  {
    ...
    title: '안전보건계획서',
    shortTitle: '안전보건계획서',
    description: '공사 개요와 사업장 정보를 바탕으로 계획서 초안을 만들고 편집할 수 있습니다.',
    ...
    highlights: ['문서 편집', '안전정보 입력'],
  },
  {
    id: 'safety-management-fee',
    title: '안전보건관리비 계획서',
    shortTitle: '관리비 계획서',
    description: '사업 종류와 금액에 따라 안전보건관리비 사용계획서를 계산하고 문서화합니다.',
  ...
  },
  {
    ...
    description: '안전관리 업무를 할 일 목록으로 정리하고 완료 여부를 확인합니다.',
    href: '/safety-log',
    category: 'document',
    status: 'stable',
    icon: 'document',
  ...
  },
  {
    ...
    title: '일일 안전일지',
    shortTitle: '안전일지',
    description: '일일 안전 점검 사항과 작업 내용을 기록하고 관리하는 일지를 작성합니다.',
  ...
  },
  {
    ...
    title: '안전작업 허가서',
    shortTitle: '작업허가서',
    description: '작업 전 작업 종류별 위험요인을 확인하고 안전작업 허가서를 작성 및 관리합니다.',
    href: '/work-permit',
    category: 'document',
    status: 'stable',
    icon: 'document',

# 이미지 분석 애플리케이션 (AI Safety Riska)

Google Gemini API를 활용하여 이미지를 분석하고 안전보건계획서를 자동 생성하는 Next.js 웹 애플리케이션입니다.

## 주요 기능

- **Firebase 인증 시스템**: 이메일/비밀번호 가입 및 Google 소셜 로그인 지원
- **사용자 프로필 관리**: 소속, 이름, 전화번호 등 사용자 추가 정보 수집 및 관리
- **이미지 분석**: Google Gemini API를 사용하여 산업 환경의 위험 요소를 실시간 분석
- **안전보건계획서 자동화**: AI를 통한 사업장 맞춤형 계획서 및 위험성평가 생성
- **게시판**: 자유로운 소통과 정보 공유를 위한 커뮤니티 공간

      ...
      <nav className="fixed top-0 z-50 w-full border-b border-slate-100 bg-white/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:h-20 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3">
            {/* next/image 최적화 400 회피: public 정적 파일은 일반 img 권장 */}
            <img
              src="/icon.png"
              alt="모두의 안전"
              width={40}
              height={40}
              className="h-9 w-9 shrink-0 rounded-xl object-contain shadow-md ring-1 ring-slate-200/80 sm:h-10 sm:w-10 sm:rounded-2xl"
              decoding="async"
            />
            <span className="text-base font-black tracking-tight text-slate-900 sm:text-lg">모두의 안전</span>
          </Link>
